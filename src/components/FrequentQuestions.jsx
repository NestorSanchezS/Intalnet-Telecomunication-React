              ...
              <div className="row">
                <div className="col-xl-4">
                  ...
                  <p>
                    ...
                    Resolución CRC 5050 de 2016. Así las cosas, los Usuarios
                    están obligados a pagar oportunamente la factura por la
                    prestación de los servicios de internet y televisión por
                    suscripción.
                  </p>
                </div>
                <div className="col-xl-4">
                  ...
                  <p>
                    ...
                    suscripción e internet tienen la obligación de pagar
                    oportunamente la factura. Ahora bien, bajo la premisa que
                    son servicios esenciales esta Comisión exhorta a los
                    operadores a que les brinden a los Usuarios facilidades de
                    pago.
                  </p>
                </div>
                <div className="col-xl-4">
                  ...
                  <p>
                    ...
                    S.A.S) avisará a los Usuarios los cortes del servicio que
                    realizará por falta de pago.
                  </p>
                </div>
              </div>
              <div className="row">
                <div className="col-xl-4">
                  ...
                  <p>
                    ...
                    perdure la emergencia no podemos cobrar intereses por mora.
                    Lo anterior no implica condonaciones de las sumas que los
                    usuarios deben.
                  </p>
                </div>
                <div className="col-xl-4">
                  ...
                  <p>
                    ...
                    correo electrónico, aunque no haya sido el mismo medio por
                    el que se presentó o el Usuario no lo haya autorizado
                    expresamente. Esta misma norma faculta al operador a enviar
                    la factura por correo electrónico aun cuando el Usuario no
                    lo haya autorizado. Si no se cuenta con el correo
                    electrónico INTALNET TELECOMUNICACIONES (Inversiones Zuluaga
                    Sejin S.A.S) entregará la factura y la respuesta de la PQRs
                    en físico.
                  </p>
                </div>
                <div className="col-xl-4">
                  ...
                  <p>
                    ...
                    INTALNET TELECOMUNICACIONES (Inversiones Zuluaga Sejin
                    S.A.S) es el primer canal de solución. Ahora bien, solo en
                    el caso que no demos respuesta oportunamente el Usuario
                    podrá acudir a la SIC.
                  </p>
                </div>
              </div>
              <div className="row">
                <div className="col-xl-4">
                  ...
                  <p>
                    ...
                    Suele ser un recurso compartido por numerosos usuarios (por
                ...
                <div className="col-xl-4">
                  ...
                  <p>
                    ...
                    'fidelidad sin cables o inalámbrica'. La comunicación
                    inalámbrica, como tal, es aquella que prescinde de cables o
                    medios físicos visibles de propagación, y que, por el
                    contrario, emplea ondas electromagnéticas para su
                    trasmisión, siendo que esta, no obstante, estará limitada a
                    un radio específico de cobertura.
                  </p>
                </div>
                <div className="col-xl-4">
                  ...
                  <p>
                    ...
                    tendrás uno que es el que te conecta con Internet. Los
                    routers funcionan utilizando direcciones IP para saber a
                    donde tienen que ir los paquetes de datos cuando se compra
                    el servicio.
                  </p>
                </div>
              </div>
